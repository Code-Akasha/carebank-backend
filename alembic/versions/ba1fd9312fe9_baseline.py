...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_action_executions_approval_request_id'), 'action_executions', ['approval_request_id'], unique=False)
    ...
    op.create_index(op.f('ix_action_executions_request_hash'), 'action_executions', ['request_hash'], unique=False)
    ...
    op.create_index(op.f('ix_action_requests_id'), 'action_requests', ['id'], unique=False)
    op.create_index(op.f('ix_action_requests_idempotency_key'), 'action_requests', ['idempotency_key'], unique=False)
    op.create_index(op.f('ix_action_requests_linked_execution_id'), 'action_requests', ['linked_execution_id'], unique=False)
    op.create_index(op.f('ix_action_requests_request_hash'), 'action_requests', ['request_hash'], unique=False)
    ...
    op.create_index(op.f('ix_checklist_items_recurring_rule_id'), 'checklist_items', ['recurring_rule_id'], unique=False)
    ...
    op.create_index(op.f('ix_financial_plans_id'), 'financial_plans', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_recurring_rules_next_run_date'), 'recurring_rules', ['next_run_date'], unique=False)
    op.create_index(op.f('ix_recurring_rules_plan_id'), 'recurring_rules', ['plan_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_recurring_rules_next_run_date'), table_name='recurring_rules')
    ...
    op.drop_index(op.f('ix_checklist_items_recurring_rule_id'), table_name='checklist_items')
    ...
    op.drop_index(op.f('ix_action_requests_linked_execution_id'), table_name='action_requests')
    ...
    op.drop_index(op.f('ix_action_executions_request_hash'), table_name='action_executions')
    ...
    op.drop_index(op.f('ix_action_executions_approval_request_id'), table_name='action_executions')
