...
class TestBeneficiaryService:
    ...
    def test_list_beneficiaries_for_user(self, test_db, test_user_data, test_beneficiary_data):
    ...
    def test_list_beneficiaries_isolation(self, test_db, test_user_data, test_beneficiary_data):
