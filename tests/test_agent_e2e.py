...
class TestPaymentAgentE2E:
    ...
    def test_payment_agent_start_state(self, test_db, test_user_data):
        ...
        assert "beneficiary" in response.message.lower() or "pay" in response.message.lower()
        # Should show list of beneficiaries
        assert len(response.options) > 0

    def test_payment_agent_full_flow(self, test_db, test_user_data, test_beneficiary_data):
        ...
        assert "confirm" in resp4.message.lower() or "success" in resp4.message.lower() or "mpin" in resp4.message.lower()

    def test_payment_agent_error_recovery(self, test_db, test_user_data, test_beneficiary_data):
    ...
    def test_payment_agent_amount_validation(self, test_db, test_user_data, test_beneficiary_data):
...
class TestRecurringPaymentAgentE2E:
    ...
    def test_recurring_agent_start_state(self, test_db, test_user_data):
        ...
        response = agent.process_message(user_id, "I want to set up a recurring payment", context)
        
        assert response is not None
        # Should ask about beneficiary or frequency
        assert len(response.options) > 0

    def test_recurring_agent_daily_setup_flow(self, test_db, test_user_data, test_beneficiary_data):
    ...
    def test_recurring_agent_weekly_setup_flow(self, test_db, test_user_data, test_beneficiary_data):
        ...
        assert resp5.context.day_of_week is not None or "day_of_week" in str(resp5.context.day_config)

    def test_recurring_agent_monthly_setup_flow(self, test_db, test_user_data, test_beneficiary_data):
        ...
        assert resp5.context.day_of_month == 15 or resp5.context.day_config.get("day_of_month") == 15

    def test_recurring_agent_dates_setup(self, test_db, test_user_data, test_beneficiary_data):
    ...
    def test_recurring_agent_quarterly_setup(self, test_db, test_user_data, test_beneficiary_data):
    ...
    def test_recurring_agent_zero_amount_validation(self, test_db, test_user_data, test_beneficiary_data):
...
class TestAgentUserIsolation:
    ...
    def test_payment_agent_user_isolation(self, test_db, test_user_data, test_user_2, test_beneficiary_data):
