...
class PaymentAgent:
    ...
    def process_message(self, user_id: str, message: str, context: PaymentContext) -> PaymentAgentResponse:
    ...
    def _handle_start(self, user_id: str, message: str, context: PaymentContext) -> PaymentAgentResponse:
    ...
    def _handle_beneficiary_selection(self, user_id: str, message: str, context: PaymentContext) -> PaymentAgentResponse:
    ...
    def _handle_amount_entry(self, user_id: str, message: str, context: PaymentContext) -> PaymentAgentResponse:
        """Handle amount input."""
        ...
        try:
            ...
            if user.account_number:
                available_methods.append({"label": "Account Transfer", "value": "account_transfer"})
    ...
    def _handle_method_selection(self, user_id: str, message: str, context: PaymentContext) -> PaymentAgentResponse:
    ...
    def _generate_confirmation(self, context: PaymentContext) -> PaymentAgentResponse:
        ...
        if context.beneficiary_id:
            beneficiary = self.db.query(Beneficiary).filter(
                Beneficiary.id == context.beneficiary_id
            ).first()
        ...
        settings = self.db.query(PaymentSettings).filter(
            PaymentSettings.user_id == context.user_id
        ).first()
    ...
    def _handle_confirmation(self, user_id: str, message: str, context: PaymentContext) -> PaymentAgentResponse:
        """Handle confirmation."""
    ...
    def _handle_mpin_entry(self, user_id: str, message: str, context: PaymentContext) -> PaymentAgentResponse:
        """Handle MPIN entry."""
    ...
    def _execute_payment(self, user_id: str, context: PaymentContext, mpin: Optional[str]) -> PaymentAgentResponse:
        """Execute the payment."""
